...
int main()
{
    ...
    int arr[13] =  {100, 102, 103, 104, 105, 106, 107, 108, 109, 110, 111, 112, 113};

    vector<int>stud_IDs(arr,arr+13);

    string s_arr[13] = {"Dev", "Jerry", "Doug", "Lebron", "Chris", "Gary", "Miller", "Harold", "Von", "Randall", "Keenan", "Bella", "Carter"};

    vector<string> stud_Names(s_arr,s_arr+13);

    string e_arr[13] = {"dm06@txstate.edu", "jk12@txstate.edu", "dg45@txstate.edu", "lj23@txstate.edu",
    ...
    vector<string> stud_Emails(e_arr,e_arr+13);
